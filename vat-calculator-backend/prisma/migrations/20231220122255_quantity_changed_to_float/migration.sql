/*
  ...
  - You are about to alter the column `quantity` on the `inventory` table. The data in that column could be lost. The data in that column will be cast from `Decimal(65,30)` to `Double`.
  - You are about to alter the column `quantity` on the `saleorder` table. The data in that column could be lost. The data in that column will be cast from `Decimal(65,30)` to `Double`.
...
-- AlterTable
ALTER TABLE `inventory` MODIFY `quantity` DOUBLE NOT NULL;

-- AlterTable
ALTER TABLE `saleorder` MODIFY `quantity` DOUBLE NOT NULL;
